...
public class ESPDMXConfig extends JFrame {
	...
	public void initInterface() {
		...
		_jrbAccessPoint = new JRadioButton(ACCESS_POINT);
		_jrbAccessPoint.setActionCommand(ACCESS_POINT);
		_jrbAccessPoint.setLocation(new Point(130, 80));
		_jrbAccessPoint.setSize(new Dimension(200, 20));
		_jrbAccessPoint.addActionListener(new ActionListener() {
		...
		_jrbStation.setLocation(new Point(355, 80));
		_jrbStation.setSize(new Dimension(200, 20));
		...
		_jtfAccessPointIP.setLocation(new java.awt.Point(110, 120));
		...
		jLabel3.setLocation(new java.awt.Point(28, 122));
		add(jLabel3);
		...
		_jtfAccessPointGateway.setLocation(new java.awt.Point(110, 150));
		...
		jLabel4.setLocation(new java.awt.Point(28, 152));
		add(jLabel4);
		...
		_jtfAccessPointSubnet.setLocation(new java.awt.Point(110, 180));
		...
		jLabel5.setLocation(new java.awt.Point(28, 182));
		add(jLabel5);
		...
		_jtfStationIP.setLocation(new java.awt.Point(355, 120));
		add(_jtfStationIP);
		...
		jLabel6.setLocation(new java.awt.Point(272, 122));
		add(jLabel6);
		...
		_jtfStationGateway.setLocation(new java.awt.Point(355, 150));
		...
		jLabel7.setLocation(new java.awt.Point(272, 152));
		add(jLabel7);
		...
		_jtfStationSubnet.setLocation(new java.awt.Point(355, 180));
		...
		jLabel8.setLocation(new java.awt.Point(272, 182));
		add(jLabel8);

		// more radio buttons

		_jrbStatic = new JRadioButton("Static");
		_jrbStatic.setLocation(new Point(130, 220));
		_jrbStatic.setSize(new Dimension(200, 20));
		_jrbStatic.setSelected(true);

		_jrbDHCP = new JRadioButton("DHCP");
		_jrbDHCP.setLocation(new Point(355, 220));
		_jrbDHCP.setSize(new Dimension(200, 20));
		...
		_jrbMulticast.setLocation(new Point(130, 250));
		_jrbMulticast.setSize(new Dimension(200, 20));

		_jrbBroadcast = new JRadioButton("Broadcast");
		_jrbBroadcast.setLocation(new Point(355, 250));
		...
		_jrbSACN.setLocation(new Point(130, 290));
		_jrbSACN.setSize(new Dimension(200, 20));

		_jrbArtNet = new JRadioButton("Art-Net");
		_jrbArtNet.setLocation(new Point(355, 290));
		...
		_jtfMulticastAddress.setLocation(new java.awt.Point(110, 330));
		...
		jLabel10.setLocation(new java.awt.Point(8, 362));
		add(jLabel10);
		...
		_jtfArtNetSubnet.setLocation(new java.awt.Point(355, 330));
		...
		jLabel11.setLocation(new java.awt.Point(242, 332));
		add(jLabel11);
		...
		_jtfArtNetUniverse.setLocation(new java.awt.Point(355, 360));
		...
		jLabel12.setLocation(new java.awt.Point(232, 362));
		add(jLabel12);
		...
		_jtfArtNetNodeName.setLocation(new java.awt.Point(355, 390));
		...
		jLabel13.setLocation(new java.awt.Point(232, 392));
		add(jLabel13);

		_jbClearOutput = new JButton("Clear Output");
		_jbClearOutput.setSize(new Dimension(120, 25));
		_jbClearOutput.setLocation(new Point(490, 420));
		...
		_jbCancelMerge.setLocation(new Point(355, 420));
		...
		_line1 = new Line2D.Float(10, 490, 640, 490);
		...
		_jcbTargetSelect.setLocation(new Point(110, 480));
		...
		jLabel14.setLocation(new java.awt.Point(28, 482));
		add(jLabel14);

		_jrbTargetSACN = new JRadioButton("sACN");
		_jrbTargetSACN.setLocation(new Point(425, 482));
		_jrbTargetSACN.setSize(new Dimension(90, 20));

		_jrbTargetArtNet = new JRadioButton("Art-Net");
		_jrbTargetArtNet.setLocation(new Point(510, 482));
		...
		jLabel15.setLocation(new java.awt.Point(345, 482));
		add(jLabel15);
		...
		_jbGetInfo.setLocation(new Point(110, 525));
		...
		_jbUpload.setLocation(new Point(355, 525));
	...
	public void paint(Graphics g) {
        ...
        if ( _image1 != null ) {
        	_image1.paintIcon(this, g, 525, 60);
        }
    }
	...
	public int upload() {
		...
		try {
			InetAddress to_ip = InetAddress.getByName(ipstr);
			sendPacket = new DatagramPacket(packet_buffer, 204, to_ip, udpport);
		} catch ( Exception e) {
